(function(blocks, editor, components, i18n, element) {
  ...
  registerBlockType("organic/profile-block", {
    // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
    title: i18n.__("Bukazu-Portal"), // The title of our block.
    description: i18n.__(
      "A custom block for displaying bukazu calendars and search page."
    ), // The description of our block.
    icon: "calendar", // Dashicon icon for our block. Custom icons can be added using inline SVGs.
    ...
    edit: function(props) {
      ...
      var portalCode = props.attributes.portalCode;
        ...
        el(
          ...
          el(
            ...
            el(
              "p",
              {},
              i18n.__("Add links to your social media profiles.")
            ),
            ...
            el(TextControl, {
              type: "text",
              label: i18n.__("Portal Code"),
              value: portalCode,
              onChange: function(newEmail) {
                props.setAttributes({ portalCode: newEmail });
              }
            })
          )
        ),
